...
use crate::ecs::research_contracts::{
    ClockSource, CounterSource, MemorySource, DEFAULT_CLOCK_SOURCE, DEFAULT_COUNTER_SOURCE,
    DEFAULT_MEMORY_SOURCE,
};
use crate::ecs::research_trace::{ClockDomain, StageId, SubstrateId, TraceEvent};
...
mod tests {
    use super::*;
    use crate::ecs::research_contracts::{ClockSource, MemorySource};
