use crate::ecs::inference_profile::{
...
impl MlxProbe {
    pub fn run() -> Vec<PhaseEvidenceReceipt> {
        ...
        .map(|(i, kind)| PhaseEvidenceReceipt {
            receipt_id: crate::ecs::inference_profile::ids::ReceiptId::new_random(),
            phase_id: PhaseId::new(kind.ordinal(), i as u32),
            phase_kind: kind,
            profile_id,
            backend: crate::ecs::inference_profile::backend::BackendKind::MLX,
