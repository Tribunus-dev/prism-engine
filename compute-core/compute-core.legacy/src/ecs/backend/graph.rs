...
pub struct RegionExecutionReceipt {
    ...
    pub input_tensors: Vec<crate::ecs::backend::routing::TensorId>,
    /// Logical tensor IDs produced.
    pub output_tensors: Vec<crate::ecs::backend::routing::TensorId>,
}
...
pub trait GraphBackend {
    ...
    fn execute_region(
        ...
        inputs: &[crate::ecs::backend::routing::TensorId],
