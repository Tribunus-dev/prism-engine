...
use crate::ecs::generation::diffusiongemma::DiffusionSampler;
...
pub struct DiffusionProvider {
    model: crate::ecs::generation::diffusiongemma::DiffusionModel,
}
...
impl DiffusionProvider {
    ...
    pub fn new(model_path: &str) -> Result<Self, DiffusionGenerationError> {
        ...
        let model = crate::ecs::generation::diffusiongemma::DiffusionModel::load(model_path)
