...
pub use prism_ecs_ir::cimage_types::GroupAxis;

/// Logical shape of a single tile in rows and columns.
pub use prism_ecs_ir::cimage_types::TileShape;

/// A family of tiles sharing a shape and default group sizes.
pub use prism_ecs_ir::cimage_types::TileFamily;

/// Whether the storage is row-major or column-major.
pub use prism_ecs_ir::cimage_types::StorageOrder;

/// How metadata (scales, offsets) is laid out relative to tile data.
pub use prism_ecs_ir::cimage_types::MetadataLayout;
...
pub use prism_ecs_ir::cimage_types::PhysicalTileLayout;
