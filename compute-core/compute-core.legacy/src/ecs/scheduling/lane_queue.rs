...
use crate::ecs::scheduling::lane_work::{LaneWorkRequest, WorkId};
...
mod tests {
    use super::*;
    use crate::ecs::compilation::activation_abi::{ActivationAbi, MetalOnlyParams, SlotLeaseId};
    use crate::ecs::compilation::phase_ir::TensorDtype;
    use crate::ecs::scheduling::lane_work::{next_work_id, CompletionClock, StreamId};
    ...
    fn entry(priority: WorkPriority, work_id: WorkId) -> QueueEntry {
        QueueEntry {
            ...
            priority,
            deadline: None,
            request: crate::ecs::scheduling::lane_work::LaneWorkRequest {
                work_id,
