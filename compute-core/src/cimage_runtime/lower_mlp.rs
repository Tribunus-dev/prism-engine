...
use crate::cimage_runtime::receipts::CImageBindingReceipt;
use crate::cimage_runtime::tensor_store::{MlpRegionExecutionMode, RuntimeTensorStore};
            ...
            .map(|op| {
                ...
                CImageBindingReceipt {
                    ...
                    bindings: op
                        ...
                        .iter()
                        .map(
                            |b| crate::cimage_runtime::receipts::CImageKernelBindingInfo {
                                slot: b.slot,
