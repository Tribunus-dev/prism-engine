...
//!
//! Mirrors [`crate::compute_image::compile::pipeline::compile_sequential`] but
...
pub fn compile_audio_model(
    ...
    let manifest = CimageManifest {
        ...
        architecture: crate::config::ArchitectureConfig::Audio(
            crate::config::hardware::AudioArchitecture {
                hidden_size: 384,
