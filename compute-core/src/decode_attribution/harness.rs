...
fn run_backend_accelerate(
    ...
    let tier =
        crate::decode_attribution::backend_adapters::accelerate_adapter::support_tier(family.name);
    ...
    let domain_result =
        match crate::decode_attribution::backend_adapters::accelerate_adapter::run_family(
            family.name,
            &input_data,
            &weights,
            profile,
    ...
    for _ in 0..steady_iters {
        let _ = crate::decode_attribution::backend_adapters::accelerate_adapter::run_family(
            family.name,
            &input_data,
            &weights,
            profile,
