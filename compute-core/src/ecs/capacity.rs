//! Capacity policy types for World and ComponentStore.
//!
//! Capacity is a performance hint, never a correctness limit. Exceeding the
//! initial capacity grows storage unless a separately declared bounded-world
//! policy forbids it.
