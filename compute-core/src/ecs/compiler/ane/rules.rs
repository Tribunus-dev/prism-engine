...
mod ledger_tests {
    ...
    fn all_rules_have_evidence_state() {
        ...
        let region = crate::ecs::compiler::scheduled::ScheduledRegion {
            region_id: crate::ecs::compiler::scheduled::RegionId(1),
            name: "test".into(),
            operations: vec![],
            selected_backend: crate::ecs::backend::routing::BACKEND_MLX,
