...
use crate::ecs::compiler::ane::legality::{AneLegality, LegalityStatus};
...
fn register_all_ane_rules(legality: &mut AneLegality) {
    use crate::ecs::compiler::ane::rules::{
...
fn matmul_produces_compile_plan() {
    ...
    let prog_id = AneProgramArtifactIdentity {
        artifact_id: crate::ecs::backend::routing::BackendArtifactId(100),
