...
pub use prism_ecs_compile::compilation::tri_lane::{
...
pub struct AppleTriLaneArtifactManifest {
    ...
    pub epochs: Vec<prism_ecs_compile::compilation::tri_lane::ExecutionEpoch>,
    pub dependencies: Vec<prism_ecs_compile::compilation::tri_lane::LaneDependency>,
