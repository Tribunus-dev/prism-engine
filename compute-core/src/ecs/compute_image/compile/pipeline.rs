...
) -> Result<crate::ecs::compute_image::compatibility::CompileDecision, String> {
...
pub(crate) fn compile_sequential(
    ...
    for (key, spec) in &requests {
        ...
        let artifact = MetalKernelArtifact {
            ...
            kind: if spec.nf4_tile640 {
                crate::ecs::compute_image::manifest::ArtifactKind::Nf4Tile640Shared
            } else {
                crate::ecs::compute_image::manifest::ArtifactKind::MlxNf4U32
            },
    ...
    // ── Phase DAG emission ──────────────────────────────────────────
    use crate::ecs::compute_image::phase_graph_builder::PhaseGraphBuilder;
