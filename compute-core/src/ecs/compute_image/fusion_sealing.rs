...
use crate::ecs::compute_image::fusion_abi::{ArtifactHash, SealedMetalFusionArtifact};
...
mod tests {
    use super::*;
    use crate::ecs::compute_image::fusion_abi::{MetalFusionFamily, MetalLaunchContract};
