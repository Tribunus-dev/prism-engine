...
fn emit_tensor(
    builder: &mut crate::ecs::compute_image::manifest::ImageBuilder,
...
pub(crate) fn compute_manifest_hash(manifest: &Manifest) -> String {
    ...
    struct Fingerprint<'a> {
        ...
        segments: &'a [crate::ecs::compute_image::manifest::Segment],
        tensor_table: &'a [crate::ecs::compute_image::manifest::TensorEntry],
        alias_table: &'a [crate::ecs::compute_image::manifest::AliasEntry],
        residency_plan: &'a crate::ecs::compute_image::manifest::ResidencyPlan,
    }
