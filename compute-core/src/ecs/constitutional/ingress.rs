...
impl ResolveIngressCommand {
    ...
    pub fn preflight(
        ...
        let entity = crate::ecs::CompEntity(self.ingress_entity);
    ...
    pub fn execute(
        ...
        if let Some(ingress_req) =
            world.get_component::<IngressRequest>(crate::ecs::CompEntity(self.ingress_entity))
        {
...
impl crate::ecs::Component for IngressRequest {}
impl crate::ecs::Component for ApiKey {}
impl crate::ecs::Component for RateLimiterState {}
...
mod tests {
    use super::*;
    use crate::ecs::constitutional::schema::*;
