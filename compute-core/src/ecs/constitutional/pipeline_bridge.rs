...
use crate::ecs::constitutional::schema::{ComponentDurability, SchemaEntry, SchemaRegistry};
...
impl PipelineBridge {
    ...
    fn make_multimodal_registry() -> SchemaRegistry {
        ...
        reg.register(SchemaEntry {
            ...
            type_id: Some(std::any::TypeId::of::<
                crate::ecs::constitutional::multimodal::Pipeline,
            >()),
        });
        reg.register(SchemaEntry {
        ...
        reg.register(SchemaEntry {
            ...
            durability: ComponentDurability::Durable,
            type_id: Some(std::any::TypeId::of::<
                crate::ecs::constitutional::multimodal::InputArtifactRef,
            >()),
        });
        reg.register(SchemaEntry {
            ...
            durability: ComponentDurability::Durable,
            type_id: Some(std::any::TypeId::of::<
                crate::ecs::constitutional::multimodal::OutputArtifactRef,
            >()),
        });
        reg.register(SchemaEntry {
            ...
            durability: ComponentDurability::Durable,
            type_id: Some(std::any::TypeId::of::<
                crate::ecs::constitutional::multimodal::PipelineLifecycle,
            >()),
        });
        reg.register(SchemaEntry {
            ...
            durability: ComponentDurability::Durable,
            type_id: Some(std::any::TypeId::of::<
                crate::ecs::constitutional::multimodal::WorkLeaseRef,
            >()),
        });
        reg
    }
    ...
    /// [`MultimodalError`](crate::ecs::constitutional::multimodal::MultimodalError)
    /// on failure.
    pub fn create_pipeline(
        ...
        crate::ecs::constitutional::multimodal::MultimodalError,
    > {
