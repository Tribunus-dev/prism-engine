...
pub use crate::ecs::arena_info::ArenaInfo;
#[cfg(feature = "mlx-backend")] // research surface: MLX executor/model stack
use crate::ecs::external_array::ExternalStorage;
...
impl Arena {
    ...
    pub fn new_bytes(byte_count: u32) -> Result<Self, String> {
        ...
        // Try IOSurface-backed allocation first.
        let mut info: ArenaInfo = unsafe { std::mem::zeroed() };
...
mod tests {
    ...
    use crate::ecs::coreai_state::CoreAiStateHandle;
