...
extern "C" {
    ...
    fn tribunus_coreai_predict_stateful(
        ...
        input_name: *const i8,
        input_arena: *const crate::ecs::arena::ArenaInfo,
        output_name: *const i8,
        output_arena: *mut crate::ecs::arena::ArenaInfo,
    ) -> i32;
...
impl CoreAiStateHandle {
    ...
    pub fn predict_stateful(
        ...
        input_name: &str,
        input_arena: &crate::ecs::arena::ArenaInfo,
        output_name: &str,
        output_arena: &mut crate::ecs::arena::ArenaInfo,
    ) -> Result<(), String> {
...
pub struct StatefulPrefillContext {
    ...
    pub k_arena: Option<crate::ecs::arena::Arena>,
    pub v_arena: Option<crate::ecs::arena::Arena>,
}
