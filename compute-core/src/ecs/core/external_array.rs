...
use crate::ecs::mapped_image::MappedSegment;
...
/// Borrowed storage: references memory owned by another entity.
/// Drop is a no-op — the owner (Tribunus) is responsible for freeing.
pub struct BorrowedStorage {
    pub ptr: *const u8,
    pub len: usize,
}
...
unsafe impl Send for BorrowedStorage {}
unsafe impl Sync for BorrowedStorage {}
