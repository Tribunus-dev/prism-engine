...
use crate::ecs::cpu_runtime::capabilities::{CpuBackendCapability, CpuProgramOp};
use crate::ecs::cpu_runtime::rayon_strategy::{CpuScratchPlan, RayonStrategy};
use crate::ecs::cpu_runtime::receipts::CpuLoweringReceipt;
...
mod tests {
    ...
    fn cpu_cap() -> CpuBackendCapability {
        ...
        crate::ecs::cpu_runtime::capabilities::register_accelerate_rayon_capabilities(&mut c);
        c
    }
