...
mod tests {
    ...
    fn calibration_is_non_zero() {
        ...
        assert!(
            cal.timer_overhead_ns < 10_000,
            "unexpectedly large timer overhead: {} ns",
            cal.timer_overhead_ns
        );
    ...
    fn calibration_is_stable() {
        ...
        assert!(
            a.timer_overhead_ns <= b.timer_overhead_ns * 10
                || b.timer_overhead_ns <= a.timer_overhead_ns * 10,
            "unstable calibration: {} vs {}",
            a.timer_overhead_ns,
            b.timer_overhead_ns
        );
    }
