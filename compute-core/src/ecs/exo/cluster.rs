...
use crate::ecs::exo::autoscaler::Autoscaler;
use crate::ecs::exo::hardware::{detect_ane_cores, detect_hardware, format_chip_name};
...
impl ExoNode {
    ...
    pub fn enable_autoscaling(&mut self, min: u32, max: u32) -> Result<(), String> {
        let telemetry = crate::ecs::scheduling::InferenceTelemetry::global();
...
use crate::ecs::exo::hardware::HardwareInfo;

use crate::ecs::exo::autoscaler::ScaleAction;
