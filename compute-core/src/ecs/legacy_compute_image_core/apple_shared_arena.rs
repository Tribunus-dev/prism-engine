...
pub use super::slot_types::{SlotFailureReason, SlotState};
...
pub use super::slot_types::SlotReuseClass;
...
impl AppleSharedArena {
    ...
    pub fn install(
        manifest: &crate::ecs::legacy_compute_image_core::apple_cimage_manifest::AppleSharedArenaManifest,
    ) -> Result<Self, String> {
