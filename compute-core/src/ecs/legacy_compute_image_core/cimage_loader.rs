...
//!
//! [`TernaryCImageCompiler`]: crate::ecs::legacy_compute_image_core::ternary_compile::TernaryCImageCompiler
//! [`TernaryCImageCompiler`]: crate::ecs::legacy_compute_image_core::compile::ternary::TernaryCImageCompiler

use super::compile::execution_graph::ExecutionGraphDescriptor;
use super::compile::ternary::{
...
use super::megakernel::kernels::HIDDEN_DIM;
use super::multimodal::descriptor::{
...
use super::multimodal::SealedMultimodalBindings;
...
pub use super::compile::ternary::{PrismCimageHeader, PrismCimageLayoutMeta};
...
/// [`AlignedMmapBuilder`]: crate::ecs::legacy_compute_image_core::cimage_packer::builder::AlignedMmapBuilder
...
pub struct CimageDeployment {
    ...
    pub header: crate::ecs::legacy_compute_image_core::manifest::CImageHeader,
...
impl CimageDeployment {
    ...
    fn load_v1(bytes: Vec<u8>, device: &metal::Device) -> Result<Self, String> {
        ...
        type ManHeader = crate::ecs::legacy_compute_image_core::manifest::CImageHeader;
        let header: ManHeader =
            unsafe { std::ptr::read_unaligned(bytes.as_ptr() as *const ManHeader) };

        if header.magic != crate::ecs::legacy_compute_image_core::manifest::CIMAGE_MAGIC {
            return Err(format!(
                "bad magic: 0x{:08X} (expected 0x{:08X})",
                header.magic,
                crate::ecs::legacy_compute_image_core::manifest::CIMAGE_MAGIC
            ));
        }
    ...
    fn load_v2(bytes: Vec<u8>, device: &metal::Device) -> Result<Self, String> {
        ...
        let weight_kind = if header.quantization_schema
            == crate::ecs::legacy_compute_image_core::compile::ternary::QUANT_SCHEMA_NF4_TILE640
        {
        ...
        Ok(Self {
            header: crate::ecs::legacy_compute_image_core::manifest::CImageHeader::default(),
    ...
    pub fn maybe_expand_to_int4(&mut self, device: &metal::Device) -> Result<(), String> {
        ...
        let blocks = crate::ecs::legacy_compute_image_core::compile::int4_pack::repack_ternary_tensor(src);
        let block_bytes =
        ...
        for layer in 0..self.num_layers as usize {
            ...
            let layer_fused =
                crate::ecs::legacy_compute_image_core::compile::int4_pack::interleave_fused_ternary_layer(
                    q,
                    k,
                    v,
                    o,
    ...
    pub fn verify(
        ...
        (
            crate::ecs::legacy_compute_image_core::manifest::CImageHeader,
            V1CImageLayoutMeta,
        ),
        String,
    > {
        ...
        type VfyHeader = crate::ecs::legacy_compute_image_core::manifest::CImageHeader;
...
pub fn load_heterogeneous_executor(
    ...
    Option<(
        ...
        crate::ecs::legacy_compute_image_core::heterogeneous::types::HeterogeneousExecutionImage,
    )>,
    String,
> {
    ...
    use super::heterogeneous::types::HeterogeneousExecutionImage;
    ...
    let mut executor = match cimage_path {
        Some(path) => crate::ecs::backend::create_inference_executor(path, batch_size, int4_mode)?,
        None => crate::ecs::backend::create_heterogeneous_executor()?,
    };
...
mod tests {
    use super::*;
    use super::multimodal::descriptor::MULTIMODAL_DESCRIPTOR_MAGIC;
