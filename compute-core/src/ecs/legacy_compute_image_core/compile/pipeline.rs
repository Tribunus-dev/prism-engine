...
) -> Result<crate::ecs::legacy_compute_image_core::compatibility::CompileDecision, String> {
...
pub use super::archive::archive_ane_modelc;
#[cfg(feature = "mlx-backend")]
pub use super::archive::copy_precompiled_ane_models;
...
pub(crate) fn compile_sequential(
    ...
    crate::ecs::compiler::graph_optimizer::optimize(&mut plan_with_fusion);
    ...
    for (key, spec) in &requests {
        ...
        let artifact = MetalKernelArtifact {
            ...
            kind: if spec.nf4_tile640 {
                crate::ecs::legacy_compute_image_core::manifest::ArtifactKind::Nf4Tile640Shared
            } else {
                crate::ecs::legacy_compute_image_core::manifest::ArtifactKind::MlxNf4U32
            },
    ...
    // ── Phase DAG emission ──────────────────────────────────────────
    use crate::ecs::legacy_compute_image_core::phase_graph_builder::PhaseGraphBuilder;
                    ...
                    && q.group_size > 0 =>
            {
                ...
                match &q.storage_layout {
                    Some(layout) => match layout {
                        crate::ecs::legacy_compute_image_core::manifest::SharedWeightLayout::Nf4Tile640(_) => {
