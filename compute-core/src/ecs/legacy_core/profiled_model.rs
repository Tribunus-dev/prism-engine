...
use crate::ecs::heterogeneous::SharedMemoryIsland;
use crate::ecs::mapped_image::MappedImage;
use crate::ecs::vision::encoder::VisionEncoder;
use crate::ecs::worker_dispatch::LoadedMetalKernel;
use crate::ecs::worker_dispatch::MetalKernelRegistry;
...
pub struct LoadedProfiledModel {
    ...
    pub scheduled_module: Option<crate::ecs::compiler::scheduled::ScheduledModule>,
...
impl LoadedProfiledModel {
    ...
    pub fn new(image_dir: &Path) -> crate::Result<Self> {
        let handle_baseline = crate::ecs::bridge::handle_count();
