...
use crate::ecs::legacy_compute_image_core::compile::capability_registry::CapabilityRegistry;
use crate::ecs::legacy_compute_image_core::compile::ternary::MatrixWeightBindingV1;
pub use crate::ecs::legacy_compute_image_core::compile::ternary::ModelConfig;
...
pub fn seal_cimage(world: &mut World, model_config: ModelConfig) {
    use crate::ecs::legacy_compute_image_core::compile::ternary::{build_cimage, CompiledTensor};
