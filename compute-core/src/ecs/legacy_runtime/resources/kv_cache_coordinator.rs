...
impl SchedulableResource for KVCacheCoordinator {
    const RESOURCE_ID: ResourceId = KV_CACHE_COORDINATOR_RESOURCE;
    const NAME: &'static str = "KVCacheCoordinator";
}
...
/// `self.evolvk_budget` for inspection.
///
/// This method stays behind in the mlx-gated module because it
/// depends on `CompressedKvCache`, `EvolKV`, and `CalibrationSet`.
impl crate::kv_cache_types::PageMigrationService {
