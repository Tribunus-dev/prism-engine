...
use crate::ecs::backend::accelerate_ffi::{cblas_sgemm, CBLAS_NO_TRANS, CBLAS_ROW_MAJOR};
...
pub fn validate_operator_space_with_vectors(
    ...
    {
        use crate::ecs::compute_image::compile::kernel_dispatch::GpuBatchMatmulDispatcher;
