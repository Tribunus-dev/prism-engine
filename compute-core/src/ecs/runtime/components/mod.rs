...
pub const WORKER_INGRESS_SYSTEM: crate::ecs::runtime::scheduling::metadata::SystemId =
    crate::ecs::runtime::scheduling::metadata::SystemId(100);
pub const WORKER_EVENT_DRAIN_SYSTEM: crate::ecs::runtime::scheduling::metadata::SystemId =
    crate::ecs::runtime::scheduling::metadata::SystemId(101);
pub const WORKER_WATCHDOG_SYSTEM: crate::ecs::runtime::scheduling::metadata::SystemId =
    crate::ecs::runtime::scheduling::metadata::SystemId(102);
