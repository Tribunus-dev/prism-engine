...
pub const TEXT_TO_SPEECH_RESOURCE: crate::ecs::runtime::scheduling::component_id::ResourceId = 22;
pub const VISION_ENCODER_RESOURCE: crate::ecs::runtime::scheduling::component_id::ResourceId = 23;
