...
pub struct Schedule {
    ...
    command_buffers: Vec<Vec<crate::ecs::runtime::scheduling::command::StampedCommand>>,
    ...
    fn apply_command_buffer(
        ...
        for cmd in &sorted {
            match &cmd.command {
                ...
                crate::ecs::runtime::scheduling::command::Command::Insert {
                    entity,
                    type_id,
                    payload,
                } => {
                ...
                crate::ecs::runtime::scheduling::command::Command::Remove { entity, type_id } => {
