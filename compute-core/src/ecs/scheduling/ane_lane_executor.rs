...
use crate::ecs::backend::coreai_iosurface::{
        ...
        handle.spawn_blocking(move || {
            ...
            let _ = completion_tx.send(WorkCompletion {
                ...
                backend_status: if prediction_ok {
                    crate::ecs::scheduling::lane_work::BackendStatus::Completed
                } else {
                    crate::ecs::scheduling::lane_work::BackendStatus::Failed("prediction failed".into())
                },
