...
use crate::ecs::scheduling::tri_lane_orchestrator::{PhaseVariantSet, TriLaneOrchestrator};
...
pub struct PrismExecutionMode {
    ...
    pub risk_policy: crate::ecs::system::gates::RiskPolicy,
...
pub struct PrismStepResult {
    pub output: Vec<f32>,
    #[cfg(all(target_os = "macos", feature = "mlx-backend"))]
    pub lane_receipts: Vec<crate::ecs::scheduling::tri_lane_orchestrator::TriLaneExecutionReceipt>,
}
