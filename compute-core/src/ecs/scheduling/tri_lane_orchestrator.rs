...
pub struct TriLaneExecutionPlan {
    ...
    pub fallback_policy: crate::ecs::compilation::tri_lane::AppleFallbackPlan,
}
...
impl TriLaneOrchestrator {
    ...
    pub fn apply_completion(&mut self, completion: WorkCompletion) -> Result<(), String> {
        ...
        let receipt = TriLaneExecutionReceipt {
            ...
            input_abi: crate::ecs::compilation::activation_abi::ActivationAbi::MetalOnly(
            ...
            output_abi: crate::ecs::compilation::activation_abi::ActivationAbi::MetalOnly(
                crate::ecs::compilation::activation_abi::MetalOnlyParams {
                    name: String::new(),
                    dtype: crate::ecs::compilation::phase_ir::TensorDtype::Float16,
                    byte_count: 0,
            ...
            fallback_used: false,
            route_origin: crate::ecs::compilation::tri_lane::EpochRouteOrigin::CoreAiAne,
            numerical_status: crate::ecs::compilation::tri_lane::NumericalStatus::Pass,
        };
...
mod tests {
    ...
    use crate::ecs::compute_image::compile::portfolio::{PacketKind, WeightEncoding};
    use crate::ecs::scheduling::ane_artifact_cache::AneEvictionPolicy;
    ...
    fn sample_abi() -> ActivationAbi {
        ...
        ActivationAbi::DecodeActivationV1(
            crate::ecs::compilation::activation_abi::DecodeActivationV1Params {
                dtype: crate::ecs::compilation::phase_ir::TensorDtype::Float16,
                seq_bucket: 128,
                hidden_dim: 512,
                physical_layout:
                    crate::ecs::compilation::activation_abi::PhysicalLayout::ContiguousRowMajor,
                alignment: 64,
