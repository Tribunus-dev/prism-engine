...
impl LinuxDeviceBackend for HipBackend {
    ...
    fn synchronize(&self, _submission: &SubmissionHandle) -> Result<(), BackendError> { Err(BackendError::UnsupportedOperation("HIP stub".into())) }
}
