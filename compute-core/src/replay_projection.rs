...
impl ProjectionHarness {
    ...
    pub fn open(image_dir: &Path, layer_index: usize, family_name: &str) -> Result<Self, String> {
        ...
        let (w_arr, _) =
            crate::profiled_executor::load_tensor_from_mapped_segment(w_seg, w_entry, false)
        ...
        let (s_arr, _) =
            crate::profiled_executor::load_tensor_from_mapped_segment(s_seg, s_entry, false)
        ...
        let (b_arr, _) =
            crate::profiled_executor::load_tensor_from_mapped_segment(b_seg, b_entry, false)
