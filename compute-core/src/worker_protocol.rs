...
use crate::config::GenerationRegime;
...
/// Payload for [`WorkerEvent::DiffusionStepStarted`].
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Payload for [`WorkerEvent::DiffusionStepCompleted`].
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Payload for [`WorkerEvent::CanvasUpdated`].
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Payload for [`WorkerEvent::PositionsCommitted`].
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Payload for [`WorkerEvent::Converged`].
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Payload for [`WorkerEvent::DiffusionGenerationCompleted`].
#[derive(Debug, Clone, Serialize, Deserialize)]
