//! This module owns the canonical shared-state-schema vocabulary:
//! store declarations, kinds, and persistence modes used by regions to
//! coordinate session memory.
