#[cfg(target_os = "macos")]
use prism_ecs_core::compute_image::apple_shared_arena::AppleSharedArena;
#[cfg(target_os = "macos")]
use prism_ecs_core::compute_image::apple_shared_arena::SlotState;
...
impl MetalConsumer {
    ...
    pub fn validate(
        &mut self,
        arena: &prism_ecs_core::compute_image::apple_shared_arena::AppleSharedArena,
        _expected_epoch: u64,
