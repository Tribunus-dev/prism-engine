...
//! [`Megakernel`](prism_ecs_core::compute_image::megakernel::Megakernel) pattern.
...
use prism_ecs_core::cimage::{CImageLoader, CImagePayloadEntry, CImagePayloadRef, LoadedCImageV0};
