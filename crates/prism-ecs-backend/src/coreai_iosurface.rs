...
impl CoreAiIOSurfaceExecutable {
    ...
    pub fn bind_from_arena(
        &mut self,
        arena_slots: &[prism_ecs_core::compute_image::apple_cimage_manifest::IOSurfaceSlotManifest],
    ) -> Result<(), String> {
...
pub fn create_iosurface_from_mmap(
    ...
    let mut info = tribunus_compute_core::arena_info::ArenaInfo {
        width: 0,
        height: 0,
        logical_dim0: 0,
        logical_dim1: 0,
    ...
    let rc = unsafe {
        tribunus_compute_core::arena::tribunus_create_iosurface_from_mmap(
            &mut info as *mut tribunus_compute_core::arena_info::ArenaInfo,
...
mod tests {
    ...
    fn test_coreai_iosurface_warmup_with_arena() {
        use crate::coreai_lane::{CoreAiLane, CoreAiSubgraph, CoreAiSubgraphStatus};
        use crate::placement::ExecutionLane;
        use prism_ecs_core::compilation::tri_lane::{AneLaneLifecycle, CoreAiWarmupContract};
        use prism_ecs_core::compute_image::apple_shared_arena::{
        ...
        arena.add_slot(LiveIOSurfaceSlot {
            ...
            state: prism_ecs_core::compute_image::apple_shared_arena::SlotState::Free,
            generation: 0,
