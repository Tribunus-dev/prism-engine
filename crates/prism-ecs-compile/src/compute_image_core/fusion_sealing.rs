...
use super::fusion_abi::{ArtifactHash, SealedMetalFusionArtifact};
use sha2::{Digest, Sha256};

use crate::compute_image_core::error::now_iso8601;
...
pub fn seal_fusion_artifact(
    ...
    artifact.seal_timestamp = now_iso8601();
    artifact
}
...
mod tests {
    use super::*;
    use super::super::fusion_abi::{MetalFusionFamily, MetalLaunchContract};
