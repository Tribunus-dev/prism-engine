...
use crate::lifecycle::ArtifactLifecycle;
...
impl prism_ecs_core::Component for ArtifactPath {}
...
impl prism_ecs_core::Component for ArtifactDigest {}
...
impl prism_ecs_core::Component for ArtifactMetadata {}
...
impl prism_ecs_core::Component for ArtifactLifecycle {}
...
impl LoadArtifactCommand {
    ...
    pub fn to_effect_request(&self) -> EffectRequest {
        EffectRequest {
            ...
            kind: crate::command::EffectKind::LoadFile,
    ...
    pub fn execute(
        ...
        txn.stage_spawn(entity_id, prism_ecs_core::EntityKind::Artifact);
