...
impl prism_ecs_core::Component for ExecutionLease {}
impl prism_ecs_core::Component for LeaseOwner {}
impl prism_ecs_core::Component for LeaseTokenRange {}
impl prism_ecs_core::Component for KvSlot {}
impl prism_ecs_core::Component for KvOwnership {}
impl prism_ecs_core::Component for ExecutionOutput {}
...
pub enum ExecutionError {
    ...
    CommitFailed(crate::world_txn::WorldTxnError),
}
...
mod tests {
    ...
    fn test_acquire_lease_preflight() {
        ...
        let mut reg = crate::schema::SchemaRegistry::new();
        ...
        reg.register_for_type::<KvSlot>(
            ...
            "KvSlot",
            "kv cache slot",
            crate::schema::ComponentDurability::Ephemeral,
        );
