...
use crate::device::{DeviceMemoryLimits, DeviceStableId};
...
impl DeployModelCommand {
    ...
    pub fn to_effect_request(&self) -> EffectRequest {
        EffectRequest {
            ...
            kind: crate::command::EffectKind::MapMemory,
    ...
    pub fn preflight(
        ...
        world
            .get_component::<crate::artifact::ArtifactDigest>(artifact)
...
impl prism_ecs_core::Component for ResidencyLifecycle {}
impl prism_ecs_core::Component for ResidencyFormat {}
impl prism_ecs_core::Component for AllocationToken {}
