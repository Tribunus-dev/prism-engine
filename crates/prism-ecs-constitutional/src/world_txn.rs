...
impl WorldTxn {
    ...
    pub fn add_component_pending<T: prism_ecs_core::Component>(
        &mut self,
    ...
    pub(crate) fn add_component<T: prism_ecs_core::Component>(
        &mut self,
        entity: Entity,
        schema_id: ComponentSchemaId,
        schema_version: SchemaVersion,
    ...
    pub(crate) fn add_component_entity<T: prism_ecs_core::Component>(
        &mut self,
        entity: Entity,
        schema_id: ComponentSchemaId,
        schema_version: SchemaVersion,
    ...
    #[allow(dead_code)]
    pub(crate) fn remove_component<T: prism_ecs_core::Component>(
        &mut self,
        entity: Entity,
        schema_id: ComponentSchemaId,
    ) {
    ...
    fn push_insert<T: prism_ecs_core::Component>(
        &mut self,
        entity: Entity,
        schema_id: ComponentSchemaId,
        schema_version: SchemaVersion,
    ...
    fn push_remove<T: prism_ecs_core::Component>(
        &mut self,
        entity: Entity,
        schema_id: ComponentSchemaId,
        schema_version: SchemaVersion,
        ...
        self.removes.push(StagedRemove {
            ...
            type_id,
            is_durable,
            apply: Box::new(move |store: &mut prism_ecs_core::ComponentStore| {
...
// ══════════════════════════════════════════════════════════════════════════════
// WorldTransitExt — extension trait for World transit methods using
// prism-ecs-constitutional types, stored via type-erased extensions.
// ══════════════════════════════════════════════════════════════════════════════
...
/// type-erased extension mechanism.
...
pub(crate) struct PreparedDurableOp {
    ...
    #[allow(dead_code)]
    pub schema_key: SchemaKey,
    pub apply: Box<dyn FnOnce(&mut prism_ecs_core::ComponentStore) + Send>,
    #[allow(dead_code)]
