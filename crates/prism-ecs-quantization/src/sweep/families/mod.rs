...
use crate::sweep::candidate::{MatrixShape, PackedCandidate, QuantFamilyId};
use crate::sweep::spec::{LayoutSweepGrid, QuantFamilySweep};
...
pub trait QuantFamily: Send + Sync {
    ...
    fn enumerate(&self, grid: &crate::sweep::spec::Nf4SweepGrid) -> Vec<Self::Params>
    where
        Self::Params: 'static;
