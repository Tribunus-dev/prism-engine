...
use crate::contract::{SourceMatrixLayout, WeightValidationReport};
use crate::sweep::runner::default_validation_config;
use crate::sweep::spec::SweepScoringConfig;
use crate::sweep::{
...
fn test_layout_sweep_grid_serialization() {
    let grid = crate::sweep::spec::LayoutSweepGrid {
