...
use crate::runtime::server_types::{
    ArtifactDigest, ContextRefreshPlan, KvDispatchView, KvEpoch, KvEpochId, KvEpochReceipt,
    KvEpochState, KvPage, KvPageId, KvPageState, RopePositionContract, SparseRetentionPlan,
};
...
mod tests {
    ...
    fn make_page(page_id: KvPageId, token_start: u32, token_end: u32) -> KvPage {
        use crate::runtime::manifest::IslandAllocationId;
        KvPage {
            page_id,
            layer_range: (0, 1),
...
mod prism_backend {
    use super::*;
    // TODO: import from tribunus-compute-core when available as a dep in this crate
    // use tribunus_compute_core::kv_arena::block::PhysicalBlockId;
    // use tribunus_compute_core::kv_arena::SequenceId;

    /// Stub type until compute-core is a dependency in prism-ecs-server.
    #[allow(dead_code)]
    ...
    impl KvManager {
        ...
        pub fn try_arena_admit(&self, _epoch: &KvEpochId, _token_count: u32) -> Result<(), String> {
