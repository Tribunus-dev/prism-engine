...
use crate::manifest::{DimensionConstraint, StepRange};
use crate::types::*;
...
pub struct ImageGenerationAdmissionEvidence {
    ...
    pub required_components: Vec<crate::admission::ComponentRequirement>,
    pub present_components: Vec<crate::admission::ComponentRequirement>,
    pub missing_components: Vec<crate::admission::ComponentRequirement>,
...
pub struct ImageProviderCandidateEvidence {
    ...
    pub capability: crate::provider::ImageProviderCapability,
    pub eligible: bool,
