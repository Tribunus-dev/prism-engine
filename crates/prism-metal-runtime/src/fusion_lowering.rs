...
use tribunus_compute_core::ecs::canonical::execution_graph::ExecutionLane;
use tribunus_compute_core::ecs::canonical::execution_graph::RegionId;
...
#[cfg(test)]
use tribunus_compute_core::ecs::plan::fusion::DataflowNode;
use tribunus_compute_core::ecs::plan::fusion::DataflowOp::*;
use tribunus_compute_core::ecs::plan::fusion::{DataflowOp, FusedGroup};
use tribunus_compute_core::ecs::plan::receipts::LoweringReadiness;
...
use tribunus_compute_core::execution_profile::{GroupAxis, PhysicalTileLayout};
...
fn convert_metadata_layout(
    ml: tribunus_compute_core::execution_profile::MetadataLayout,
) -> MetadataLayout {
    use tribunus_compute_core::execution_profile::MetadataLayout as ProfMd;
    match ml {
...
pub fn metal_lower_fused_group(
    ...
    let specialization = KernelSpecializationKey {
        ...
        group_size,
        group_axis,
        affine_mode: tribunus_compute_core::execution_plan::AffineMode::ScaleOnly,
        metadata_layout,
    ...
    let lowered_op = ScheduledKernelOp {
        ...
        validation_requirements:
            tribunus_compute_core::execution_plan::KernelValidationRequirements::default(),
    };
...
mod tests {
    use super::*;
    use tribunus_compute_core::ecs::plan::fusion::MatMulContract;
    use tribunus_compute_core::execution_profile::{
