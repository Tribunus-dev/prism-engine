...
use tribunus_compute_core::execution_plan::{FunctionConstantSet, KernelSpecializationKey};
...
impl PsoCacheTrait for PsoCache {
    ...
    fn get_or_create(
        ...
        let _cache_key = tribunus_compute_core::execution_plan::pso_cache::PsoCacheKey::from(key);
