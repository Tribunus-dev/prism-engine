  ...
  const start = (context = runtimeContext()) => {
    ...
    const scenes = {
      ...
      refraction: {
        ...
        intent: 'Prism separates semantic structure without destroying coherence.',
        next: 'representation',
        ...
        takeaway: 'The prism reveals structure that was already present.',
      ...
      representation: {
        ...
        intent: 'A shared semantic representation carries intent across domains.',
        next: 'compiler',
        claim: 'repository-verified',
        knowledge: 'repository-evidence',
        existence: 'active',
        misconception: 'Every subsystem needs its own semantic model.',
        takeaway: 'One semantic object can cross implementation boundaries.',
