  ...
  const kernel = {
    ...
    receipt(event) {
      ...
      const receipt = {
        ...
        claimClass,
        evidenceScope: event.evidenceScope || event.knowledgeSource || 'illustrative-example',
        ...
        timestamp: Date.now(),
        knowledgeSource: event.knowledgeSource || 'illustrative-example',
        claim: claimClass,
    ...
    transform(transformation) {
      ...
      const receipt = this.receipt({
        ...
        knowledgeSource: 'architectural-derivation',
        claim: 'illustrative',
        confidence: 'bounded',
