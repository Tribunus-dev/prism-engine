/* @ts-self-types="./prism_docs_runtime.d.ts" */
 ...
 */
export function prism_hydrate() {
    const ret = wasm.prism_hydrate();
    if (ret[1]) {
 ...
 * @returns {string}
 */
export function prism_visitor_state_json() {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.prism_visitor_state_json();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./prism_docs_runtime_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('prism_docs_runtime_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
