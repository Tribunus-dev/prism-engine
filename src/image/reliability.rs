// ── Prism Image Generation — Reliability Types ──────────────────────────
//
// Terminal state model, admission/route/execution/output evidence,
// failure taxonomy, cancellation, qualification freshness, memory
// pressure, receipt persistence, and observability counters.
//
// This module imports from sibling modules as needed and re-exports
// its types through the facade root.

use super::manifest::{DimensionConstraint, StepRange};
use super::types::*;
...
impl std::fmt::Display for ImageGenerationTerminalState {
...
/// A request that was refused before provider execution.
#[derive(Debug, Clone)]
...
/// A request that failed during execution.
#[derive(Debug, Clone)]
...
pub struct ImageGenerationAdmissionEvidence {
    ...
    pub required_components: Vec<super::admission::ComponentRequirement>,
    pub present_components: Vec<super::admission::ComponentRequirement>,
    pub missing_components: Vec<super::admission::ComponentRequirement>,
...
pub struct ImageProviderCandidateEvidence {
    ...
    pub capability: super::provider::ImageProviderCapability,
    pub eligible: bool,
