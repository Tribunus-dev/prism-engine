...
use std::sync::Mutex;
use super::super::manifest::{ExecutionLane, QualificationStatus};
...
impl LaneRouter {
    ...
    pub fn dispatch_metal_prefill(
        ...
        Err("legacy Metal prefill router is non-authoritative; dispatch through EcsMetalLane".into())
    }
    ...
    pub fn dispatch_metal_decode(
        ...
        Err("legacy Metal decode router is non-authoritative; dispatch through EcsMetalLane".into())
    }
